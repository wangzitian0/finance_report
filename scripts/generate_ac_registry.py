...
def extract_acs() -> dict[str, dict]:
    ...
    for fname in epic_files:
        ...
        for line in lines:
            # Skip tombstone and summary lines that reference AC IDs without defining them
            stripped = line.strip()
            if stripped.startswith("*(") and "removed" in stripped.lower():
                continue
            if "removed as duplicate" in stripped.lower() or "removed as intra-epic" in stripped.lower():
                continue
