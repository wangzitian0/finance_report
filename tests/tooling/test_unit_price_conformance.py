...
def test_AC12_32_2_unit_price_policy_matches_standard():
    """AC-audit.32.2: the price quantum/policy matches the shared standard."""
...
def test_AC12_32_2_unit_price_quantize_matches_standard(case):
    """AC-audit.32.2: Python UnitPrice.quantize matches the shared 6-dp standard."""
...
def test_AC12_32_2_unit_price_product_matches_standard(case):
    """AC-audit.32.2: price * quantity reproduces the shared (exact) money amount."""
...
def test_AC12_32_2_unit_price_from_total_matches_standard(case):
    """AC-audit.32.2: from_total(...).quantize() reproduces the shared 6-dp rate."""
...
@ac_proof(
    proof_id="test_unit_price_conformance_errors",
    ac_ids=["AC-audit.32.2"],
    ci_tier="pr_ci",
)
def test_AC12_32_2_unit_price_error_cases_match_standard():
    """AC-audit.32.2: zero-quantity and unit-mismatch raise per the shared standard."""
