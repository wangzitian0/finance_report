...
def test_AC3_9_1_extraction_failed_case_registry_preserves_audit_cases_without_parser_expansion() -> None:
    """AC3.9.1: Failed parsing cases are registry-owned, not parser expansion triggers."""
    registry = yaml.safe_load((ROOT / "docs/ssot/extraction-audit-failed-cases.yaml").read_text())
