...
def _get_generator_classes() -> tuple[type, type, type]:
    dbs_cls = import_module("common.pdf_fixtures.generators.dbs_generator").DBSGenerator
    cmb_cls = import_module("common.pdf_fixtures.generators.cmb_generator").CMBGenerator
    mari_cls = import_module("common.pdf_fixtures.generators.mari_generator").MariGenerator
...
def test_ac8_13_10_futu_generated_pdf_parseable(tmp_path: Path) -> None:
    futu_generator = import_module("common.pdf_fixtures.generators.futu_generator").FutuGenerator
...
def test_ac8_13_10_moomoo_generated_pdf_parseable(tmp_path: Path) -> None:
    moomoo_generator = import_module("common.pdf_fixtures.generators.moomoo_generator").MoomooGenerator
...
def test_ac9_3_6_pingan_generated_pdf_dates_and_balances(tmp_path: Path) -> None:
    ...
    pingan_generator = import_module("common.pdf_fixtures.generators.pingan_generator").PinganGenerator
...
def test_ac8_13_10_futu_fake_data_count_boundaries() -> None:
    generate_futu_transactions = import_module(
        "common.pdf_fixtures.data.fake_data"
...
def _get_template_extractor():
    cls = import_module("common.pdf_fixtures.analyzers.template_extractor").TemplateExtractor
    return cls()
