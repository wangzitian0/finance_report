"""Tests for tools._lib.coverage.analyzer.
...
from tools._lib.coverage.analyzer import (
...
class TestRunCoverageReport:
    def test_run_coverage_report_returns_string(self, monkeypatch):
        import subprocess
        from tools._lib.coverage.analyzer import run_coverage_report
...
class TestAnalyzeModuleCoverage:
    def test_analyze_module_coverage_returns_list(self, monkeypatch):
        import subprocess
        from tools._lib.coverage.analyzer import analyze_module_coverage
...
class TestMain:
    def test_main_no_missing_lines(self, monkeypatch, capsys):
        import subprocess
        import sys
        from tools._lib.coverage.analyzer import main
    ...
    def test_main_high_avg_coverage_branch(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(sys, "argv", ["coverage_analyzer.py"])
        monkeypatch.setattr(
            "tools._lib.coverage.analyzer.analyze_module_coverage",
