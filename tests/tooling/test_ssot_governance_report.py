...
def test_AC14_1_12_report_covers_finance_and_infra2_manifest_shapes(
    ...
    """AC-meta.governance.3: AC14.1.12: SSOT governance metrics report finance and infra2 manifests."""
...
def test_AC14_1_13_incremental_gate_only_blocks_changed_ssot_debt(
    ...
    """AC-meta.governance.4: AC14.1.13: SSOT governance gates block new debt without legacy cleanup."""
...
def test_AC14_1_16_ssot_governance_ratios_cannot_regress(
    ...
    """AC-meta.governance.7: AC14.1.16: #823 gate keeps protected SSOT governance ratios from falling."""
...
def test_AC14_1_14_finance_report_orphan_ssot_files_are_manifest_owned() -> None:
    """AC-meta.governance.5: AC14.1.14: #824 cleanup binds finance_report orphan SSOT files."""
...
def test_AC14_1_15_machine_owned_ssot_entries_have_explicit_shape_and_proof() -> None:
    """AC-meta.governance.6: AC14.1.15: #824 migrates machine-owned FR SSOT entries by example."""
...
def test_AC14_1_23_high_risk_ssot_entries_bind_proof_under_platform_family() -> None:
    """AC-meta.governance.11: AC14.1.23: #824 threshold cleanup drives ``high_risk_entries_missing_proof`` to zero.
