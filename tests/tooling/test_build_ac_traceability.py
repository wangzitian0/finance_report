"""Tests for tools/build_ac_traceability.py.
...
class TestHelpers:
    ...
    def test_strip_date_normalizes_date_line(self):
        text = "> **Generated**: 2024-01-01 (mechanically by `tools/build_ac_traceability.py`)"
        assert (
            bat._strip_date(text)
            == "> **Generated**: DATE (mechanically by `tools/build_ac_traceability.py`)"
        )

    def test_strip_date_different_dates_produce_same_output(self):
        old = "> **Generated**: 2024-01-01 (mechanically by `tools/build_ac_traceability.py`)"
        new = "> **Generated**: 2099-12-31 (mechanically by `tools/build_ac_traceability.py`)"
