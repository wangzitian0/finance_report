...
# AC-testing.evidence.1): every ratchet baseline in the repo is surfaced in
# the bundle with entry count + last-shrink date, discovered by GLOB — a new
# baseline file appears with zero code changes; omitting one reds this gate.
# --------------------------------------------------------------------------- #
