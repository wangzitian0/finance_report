...
> Generated: 2026-05-19 13:35:51 UTC by `scripts/analyze_test_ac_coverage.py`
...
|---|---:|
| Registered ACs | 939 |
| Covered by real test candidates | 696 (74.1%) |
| Stub-only placeholders (`_ac_stubs`) | 232 |
...
| EPIC-008 | testing-strategy | 73 | 63 | 0 | 10 | 86.3% |
...
| EPIC-016 | two-stage-review-ui | 213 | 148 | 65 | 65 | 69.5% |
| EPIC-017 | portfolio-management | 74 | 74 | 0 | 0 | 100.0% |
...
| `AC16.17.1` | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` |
| `AC16.17.2` | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` |
| `AC16.17.3` | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` |
| `AC16.17.4` | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` |
| `AC16.18.4` | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` |
| `AC16.18.5` | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` |
| `AC16.18.6` | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` |
...
### EPIC-008 (testing-strategy) — 10 untested

`AC8.13.6`, `AC8.13.7`, `AC8.13.8`, `AC8.13.11`, `AC8.13.12`, `AC8.13.13`, `AC8.13.14`, `AC8.13.15`, `AC8.13.16`, `AC8.13.17`
