...
| AC8.13.102 | PR preview Dokploy deploys consume CI-built GHCR images with `--pull always --no-build`, disable Dokploy source auto-deploy so CI is the only rollout owner, require a Dokploy deployment record before readiness, emit redacted deployment diagnostics on rollout errors, and use commit-scoped readiness as the final public-route and expected-SHA proof | `test_AC8_13_102_dokploy_deploy_waits_for_worker_done_status`, `test_AC8_13_102_dokploy_rollout_record_window_allows_worker_queue`, `test_AC8_13_102_dokploy_rollout_timeout_fails_before_readiness`, `test_AC8_13_102_done_compose_without_new_record_proceeds_to_sha_readiness`, `test_AC8_13_102_rollout_poll_retries_transient_dokploy_api_failure`, `test_AC8_13_102_dokploy_rollout_error_fails_before_readiness`, `test_AC8_13_102_compose_error_logs_redacted_deployment_diagnostics`, `test_AC8_13_102_preview_source_disables_dokploy_auto_deploy`, `test_AC8_13_102_new_preview_redeploys_when_initial_deploy_record_is_missing`, `test_AC8_13_102_existing_preview_without_deployments_is_recreated`, `test_AC8_13_102_existing_preview_rollout_tracks_new_deployment_ids`, `test_AC8_13_102_missing_deploy_record_fails_before_readiness` | `tests/tooling/test_pr_preview_lifecycle.py` | P0 |
...
| AC8.13.104 | PR preview deploy fails before Dokploy when required inputs or commit-scoped GHCR images are missing, and every deploy attempt uploads a redacted context artifact that preserves phase, compose, route, image, and expected-SHA evidence for failure triage | `test_AC8_13_104_deploy_action_fails_fast_on_missing_required_inputs`, `test_AC8_13_104_preview_deploy_context_is_written_without_secrets`, `test_AC8_13_104_pr_preview_workflow_fast_fails_missing_images_and_uploads_context` | `tests/tooling/test_pr_preview_lifecycle.py` | P0 |
