...
- CI source coverage uses the shared coverage policy in `common/testing/coverage/policy.py`. New backend, frontend, common, and tools modules are expected to appear in the matching LCOV report unless the policy explicitly excludes them.
