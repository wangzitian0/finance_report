...
> **Predecessor**: [AC-AUDIT-2026-02-25.md](AC-AUDIT-2026-02-25.md)
> **Companion**: [AC-TEST-TRACEABILITY-AUDIT.md](AC-TEST-TRACEABILITY-AUDIT.md) (separate test-coverage track)
...
> "全方位审计的意思就是，不同文档要强一致，适当抽出 ssot， vision->epic->ac->测试 要强一致。"
...
|---|---|---|---|
| **P0a** | `docs/ac_registry.yaml` L2669–~2783 | 16 EPIC-018 ACs were placeholders (`description: TBD`, no test) | Replaced from `EPIC-018.ai-driven-pipeline.md` L234–249 SSOT table |
...
| **P1a-ext** | `docs/project/README.md` (EPIC roster) | Roster status flags lagged Phase Status table | Both surfaces now agree |
| **P1b** | `docs/project/AC-TEST-TRACEABILITY-AUDIT.md` head | Stale header citing 542-AC era | Header refreshed; body deferred to follow-up issue |
...
| **T3 — Reconciliation** | EPIC-003, EPIC-016 | ✅ `test_match_engine_*` | covered |
| **T4 — Statement Extraction** | EPIC-004, EPIC-018 | ✅ `test_extraction_pipeline_*` | covered |
