...
> Stable project entry points live in the root [README](https://github.com/wangzitian0/finance_report/blob/main/README.md), and
...
|---|---|---|---|
| 1 | **Source-type priority** (Manual > User-confirmed > Auto≥85 > Auto-parsed) | EPIC-002, EPIC-016, EPIC-018, `vision.md`, AC descriptions × 12 | `common/audit/readme.md#source-type-trust-hierarchy-provenance` (already exists — needs links pulled in from above) |
| 2 | **Confirmation workflow** (two-stage review state machine) | EPIC-016, EPIC-018, AC16.x, AC18.x | `common/extraction/confirmation-workflow.md` (already exists — needs links) |
...
| 5 | **Reconciliation thresholds** (≥85 auto, 60–84 review, <60 unmatched; 0.1 USD tolerance; 1% stats tolerance) | AGENTS.md, EPIC-003, EPIC-016, AC descriptions | `common/reconciliation/readme.md` (internalized from `common/reconciliation/reconciliation.md`, migration closeout wave 3, #1664) |
...
| `docs/project/EPIC-010.observability-logging.md` | AC numbering note | P2c |
...
- Historical infra2 pointer drift (unrelated; reverted before commit).
...
- [x] Historical infra2 pointer untouched.
...
3. **Generated traceability audit review** — use the CI `ac-test-traceability-audit` artifact and the live generated coverage/mismatch reports for current mapping; stale checked-in snapshots are retained only through issue #548 and git history.
