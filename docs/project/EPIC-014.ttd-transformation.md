...
> This group's registry/manifest/SSOT-governance/schema/HLS/high-risk-proof
> rows (formerly .6, .9, .12-.18, .23) removed — migrated to the `meta`
> package roadmap as `AC-meta.governance.1-11` (migration closeout
> continuation, #1663 / #1708).
