...
| **G2 · a year of real data ingests** | a year of real statements can be parsed, an everyday user can **seed year-start opening balances without silently shipping an incomplete balance sheet** (report generation for any month/quarter/year already works), the upload→report derivation holds at a year's volume, and manual assets and report export work | EPIC-002, EPIC-003, EPIC-005, EPIC-013, EPIC-015, EPIC-019 | [#705](https://github.com/wangzitian0/finance_report/issues/705), [#706](https://github.com/wangzitian0/finance_report/issues/706), [#949](https://github.com/wangzitian0/finance_report/issues/949) (guided opening balances), [#951](https://github.com/wangzitian0/finance_report/issues/951) (year-scale perf) (+ EPIC-019 AC19.12 derivation) |
