...
> **Scope**: All EPICs in `docs/project/`. Test scan: `apps/backend/tests`, `apps/frontend/src`.
...
|-------|-----------|-------------|-----------------|--------|
| AC1.1.1 | yes | Root moon.yml exists | `apps/backend/tests/auth/test_auth_edge_cases.py`<br>`apps/backend/tests/infra/test_epic_001_contracts.py`<br>`apps/backend/tests/review/test_statement_validation.py` | ✅ |
| AC1.1.2 | yes | apps/backend/moon.yml exists | `apps/backend/tests/review/test_statement_validation.py` | ✅ |
| AC1.1.3 | yes | apps/frontend/moon.yml exists | `apps/backend/tests/review/test_statement_validation.py` | ✅ |
...
| AC1.2.3 | yes | SQLAlchemy + Alembic config valid | `apps/backend/tests/_ac_stubs/test_epic_01_stubs.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC2.1.1 | yes | Create account with valid data | `apps/backend/tests/accounting/test_account_service_unit.py`<br>`apps/backend/tests/accounting/test_accounts_service.py`<br>`apps/backend/tests/review/test_consistency_checks.py` | ✅ |
| AC2.1.2 | yes | Get account by ID | `apps/backend/tests/accounting/test_accounts_service.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC3.1.1 | yes | Parse DBS PDF | `apps/backend/tests/extraction/test_pdf_parsing.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC4.1.1 | yes | Exact Matching | `apps/backend/tests/api/test_reconciliation_router.py`<br>`apps/backend/tests/reconciliation/test_reconciliation_matching_unit.py`<br>`apps/backend/tests/reconciliation/test_reconciliation_scoring.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC5.1.1 | yes | Accounting Equation | `apps/backend/tests/api/test_reports_router.py`<br>`apps/backend/tests/reporting/test_reporting.py` | ✅ |
| AC5.1.2 | yes | FX Unrealized Gain | `apps/backend/tests/api/test_reports_router.py`<br>`apps/backend/tests/reporting/test_reporting_fx.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC7.1.1 | yes | Infra2 submodule exists | `apps/backend/tests/_ac_stubs/test_epic_07_stubs.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC9.1.1 | yes | PDF analyzer exists | `apps/backend/tests/_ac_stubs/test_epic_09_stubs.py` | ✅ |
...
| AC9.3.7 | no |  | _none_ | ⚪ (optional, no ref) |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC10.1.1 | yes | OTEL settings in config | `apps/backend/tests/_ac_stubs/test_epic_10_stubs.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC12.1.1 | yes | OTEL logs endpoint adds suffix /v1/logs | `apps/backend/tests/infra/test_logger.py` | ✅ |
...
| AC ID | Mandatory | Description | Test References | Status |
|-------|-----------|-------------|-----------------|--------|
| AC16.1.1 | yes | Balance validation tolerance = 0.001 USD | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` | ✅ |
...
| AC16.3.1 | yes | validate_balance_chain raises ValueError when statement not found | `apps/backend/tests/review/test_statement_validation.py` | ✅ |
| AC16.3.2 | yes | _get_opening_balance falls back to opening_balance when no prev statement exists | `apps/backend/tests/review/test_statement_validation.py` | ✅ |
...
| AC16.11.1 | yes | debug — detect_environment returns CI when GITHUB_ACTIONS is true | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` | ✅ |
...
| AC16.13.1 | yes | test_lifecycle — sanitize_namespace normalizes branch/workspace names | `apps/backend/tests/_ac_stubs/test_epic_16_stubs.py` | ✅ |
