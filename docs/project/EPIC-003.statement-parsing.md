...
|----|-----------|---------------|------|----------|
| AC3.1.1 | Parse DBS PDF | `test_balance_chain_invariant_holds_for_consistent_statements`, `test_balance_chain_tolerance_is_symmetric`, `test_dbs_fixture_has_valid_structure` | `extraction/test_extraction_invariants.py`, `extraction/test_pdf_parsing.py` | P0 |
...
| AC3.5.7 | PDF/image uploads may omit model and use the default OCR pipeline. | `test_balance_chain_invariant_holds_for_consistent_statements`, `test_upload_uses_default_ocr_pipeline_for_pdf` | `extraction/test_extraction_invariants.py`, `api/test_statements_router.py` | P1 |
...
| AC3.5.19 | Retry parsing with stronger model succeeds. | `test_distinct_same_amount_rows_never_collapse`, `test_balance_chain_invariant_detects_broken_chain`, `test_retry_statement_success` | `extraction/test_extraction_invariants.py`, `api/test_statements_router.py` | P1 |
