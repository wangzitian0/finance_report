...
- **Generated traceability audit review** — current mapping comes from `scripts/check_ac_traceability.py`, generated analysis reports, and the CI `ac-test-traceability-audit` artifact rather than a checked-in snapshot.
