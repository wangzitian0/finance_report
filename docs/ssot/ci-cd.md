...
| E2E EPIC traceability | PR and `main` CI | Prove every product E2E root `test_*` function has a function-level EPIC ID and every project EPIC has at least one product E2E owner test. |
...
4. **Metric Semantics**:
   ...
   - E2E EPIC traceability fails E2E-root test functions missing function-level EPIC IDs and project EPICs without product E2E owner tests
