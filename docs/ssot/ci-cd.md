...
4. **Metric Semantics**:
   ...
   - AC traceability fails placeholder-only mandatory AC references, while listing `_ac_stubs` debt separately from real test references
