...
| `GET` | `/package/snapshots/{snapshot_id}/export` | `export_personal_report_package_snapshot` | apps/backend/src/routers/reports.py:519 |
| `GET` | `/export` | `export_report` | apps/backend/src/routers/reports.py:799 |
