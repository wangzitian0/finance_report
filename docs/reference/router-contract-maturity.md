...
|--------|-------------------------|---------|-----------|
| `DELETE` | `/{account_id}` | `delete_account` | apps/backend/src/routers/accounts.py:273 |
| `DELETE` | `/valuation-snapshots/{snapshot_id}` | `delete_valuation_snapshot` | apps/backend/src/routers/assets.py:239 |
...
| `GET` | `/package/snapshots/{snapshot_id}/export` | `export_personal_report_package_snapshot` | apps/backend/src/routers/reports.py:294 |
| `GET` | `/export` | `export_report` | apps/backend/src/routers/reports.py:582 |
| `GET` | `/{statement_id}/document` | `get_statement_document` | apps/backend/src/routers/statements.py:590 |
| `DELETE` | `/{statement_id}` | `delete_statement` | apps/backend/src/routers/statements.py:738 |
