...
| `GET` | `/{statement_id}/document` | `get_statement_document` | apps/backend/src/routers/statements.py:572 |
| `DELETE` | `/{statement_id}` | `delete_statement` | apps/backend/src/routers/statements.py:720 |
