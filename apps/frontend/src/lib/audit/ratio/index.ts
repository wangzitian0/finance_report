...
// common/audit/ratio/contract/ratio.contract.md. Proven consistent with the Python
// reference via the shared conformance vectors (common/audit/ratio/conformance/vectors.json),
