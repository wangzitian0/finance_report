...
// money standard (#1167). Contract: common/audit/money/contract/money.contract.md.
// Proven consistent with the Python reference impl via the shared conformance
// vectors (common/audit/money/conformance/vectors.json), see money.conformance.test.ts.

// Typed error hierarchy — mirrors common/audit/money/errors.py / src.audit.money.errors so
