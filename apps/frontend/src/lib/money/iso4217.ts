// AUTO-DERIVED from common/money/conformance/vectors.json (the shared standard, #1167).
// The conformance test asserts this set equals the canonical vectors set, so any
// drift from the Python reference impl turns CI red. Do not hand-edit casually.
export const ISO_4217_CODES: ReadonlySet<string> = new Set([
  ...
  "VED", "VES", "VND", "VUV", "WST", "XAF", "XAG", "XAU", "XCD", "XOF", "XPF", "YER", "ZAR",
  "ZMW", "ZWL",
]);
