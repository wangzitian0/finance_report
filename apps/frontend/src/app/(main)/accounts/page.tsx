...
export default function AccountsPage() {
  ...
  const deleteMutation = useMutation({
    mutationFn: (accountId: string) =>
      apiOperation("delete_account_accounts__account_id__delete", {
        ...
        <Alert variant="warning" className="mb-4">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <span>
              ...
              {readiness.earliest_activity_date
                ? ` since ${readiness.earliest_activity_date}`
                : ""}{" "}
              but no opening balances recorded. Set your starting balances so
              reports tie out from day one.
            </span>
            <Button
              variant="secondary"
              onClick={() => setIsOpeningBalanceOpen(true)}
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-2">
                      <div
                        ...
                        className="text-left sm:mr-2 sm:text-right"
                      >
