  ...
  return (
    <Sheet isOpen={isOpen} onClose={onClose} title="Account Details">
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            ...
            <div>
              ...
              <span
                className={`badge ${account.is_active ? "badge-success" : "badge-muted"}`}
              >
        ...
        <div className="space-y-4">
          <h4 className="font-semibold border-b border-[var(--border)] pb-2">
            Recent Transactions
          </h4>
            ...
            <div className="space-y-3">
              {entries.map((entry) => {
                ...
                return accountLines.map((line, idx) => (
                  <div
                    key={`${entry.id}-${idx}`}
                    className="p-3 rounded-lg border border-[var(--border)] hover:bg-[var(--background-muted)]/50 transition-colors"
                  >
                    <div className="flex justify-between items-start gap-4 mb-1">
                      ...
                      <p
                        className={`text-sm font-bold ${line.direction === "DEBIT" ? "text-[var(--success)]" : "text-[var(--error)]"}`}
                      >
