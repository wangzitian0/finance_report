...
describe("ReviewQueuePage - coverage additions", () => {
    ...
    it("renders checks and pending matches, toggles severity and minScore filter, select/deselect all", async () => {
        const data = {
            pending_matches: [
                { id: "m1", match_score: 90, confidence_tier: "HIGH", status: "pending", created_at: null, description: "Good match", amount: "12.3", txn_date: "2024-01-02" },
                { id: "m2", match_score: 50, confidence_tier: "HIGH", status: "pending", created_at: null, description: "Low match", amount: null, txn_date: null },
            ],
            consistency_checks: [
