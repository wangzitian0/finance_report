...
describe("Brokerage import completion route flow", () => {
  ...
  // AC-portfolio.fe-assets.3 / AC-portfolio.fe-assets2.11 / AC-portfolio.fe-assets2.12 / AC-portfolio.fe-assets2.14
  it("AC16.15.6 AC17.8.1 AC17.8.2 AC17.8.4 completes parsed statement import and portfolio value navigation", async () => {
