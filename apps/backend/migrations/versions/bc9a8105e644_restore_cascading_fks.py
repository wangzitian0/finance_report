...
def upgrade() -> None:
    ...
    for table in _USER_FK_TABLES:
        op.create_foreign_key(
            _fk_name(table), table, "users", ["user_id"], ["id"], ondelete="CASCADE"
        )
...
def downgrade() -> None:
    ...
    op.create_foreign_key("journal_lines_journal_entry_id_fkey", "journal_lines", "journal_entries", ["journal_entry_id"], ["id"])
