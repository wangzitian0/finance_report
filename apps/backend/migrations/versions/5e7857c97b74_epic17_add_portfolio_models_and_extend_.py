...
def upgrade() -> None:
    ...
    op.add_column('atomic_positions', sa.Column('asset_type', sa.Enum('stock', 'bond', 'etf', 'mutual_fund', 'property', 'cash', 'other', name='asset_type_enum', create_type=False), nullable=True, comment='Asset classification'))
    ...
    op.add_column('managed_positions', sa.Column('cost_basis_method', sa.Enum('FIFO', 'LIFO', 'AvgCost', name='cost_basis_method_enum', create_type=False), nullable=True, comment='Method for calculating realized P&L'))
