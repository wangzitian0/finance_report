...
class ReportLineId(str, Enum):
    ...
    DINING_EXPENSES = "expenses.dining"
    GROCERIES_EXPENSES = "expenses.groceries"
    TRANSPORT_EXPENSES = "expenses.transport"
    HOUSING_EXPENSES = "expenses.housing"
    UTILITIES_EXPENSES = "expenses.utilities"
    SHOPPING_EXPENSES = "expenses.shopping"
    HEALTHCARE_EXPENSES = "expenses.healthcare"
    ENTERTAINMENT_EXPENSES = "expenses.entertainment"
    TRAVEL_EXPENSES = "expenses.travel"
    EDUCATION_EXPENSES = "expenses.education"
    INSURANCE_EXPENSES = "expenses.insurance"
    FEES_EXPENSES = "expenses.fees"
