...
class NetWorthGranularity(StrEnum):
...
class PersonalReportingFrameworkId(StrEnum):
...
class PolicyFactDomain(StrEnum):
...
class PersonalReportPackageReadinessState(StrEnum):
...
class PersonalReportPackageSnapshotStatus(StrEnum):
