...
offered (it requires :func:`src.audit.money.convert` and a chosen base currency).
...
from src.audit.money.errors import FloatNotAllowedError, InvalidCurrencyError, MoneyError
