...
from src.platform.base.types.base import BaseResponse, ListResponse, MoneyAmount
...
class AccountCoverageCadence(StrEnum):
    MONTHLY = "monthly"
    DAILY_SNAPSHOT = "daily_snapshot"


class AccountCoverageIssueType(StrEnum):
    GAP = "gap"
    OVERLAP = "overlap"
