...
| `STATEMENT_DISPOSITION_MODE` | `enforce` |  |  | Feature Flags | Versioned statement-disposition rollout mode. It controls command application only; the shared policy still computes every decision. |
