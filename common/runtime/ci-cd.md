...
- The tooling-coverage job installs the same immutable `infra2-sdk v0.5.1` wheel pinned by the backend dev lock so the side-effect-free App-to-Infra request contract is tested in CI without installing or importing infra2 source.
