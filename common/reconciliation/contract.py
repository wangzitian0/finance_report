...
CONTRACT = PackageContract(
    ...
    units=[
        ...
        Unit(name="reconciliation_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="review_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="conflicts_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="derive_reconciliation_score_tier", kind=Kind.DOMAIN_SERVICE),
    ],
