...
CONTRACT = PackageContract(
    ...
    roadmap=[
        ...
        ACRecord(
            id="AC-reporting.report-integrity.1",
            statement="Processing identity retains visible in-transit assets through zero, outstanding and settled balances in both framework reports without changing cash-flow neutrality.",
            test="apps/backend/tests/reporting/test_report_integrity.py::test_processing_survives_framework_reporting",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            id="AC-reporting.report-integrity.2",
            statement="Authoritative account opening stock effective at the report start enters beginning cash without being presented as period cash activity, including explicit zero and translated foreign-currency positions.",
            test="apps/backend/tests/reporting/test_report_integrity.py::test_opening_stock_is_beginning_cash",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            id="AC-reporting.report-integrity.3",
            statement="First stock observed after the selected period start is separately disclosed as a stock adjustment with an explicit coverage blocker; spoofed or unproven opening labels never authorize starting stock.",
            test="apps/backend/tests/reporting/test_report_integrity.py::test_midperiod_opening_is_explicit_incomplete_coverage",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            id="AC-reporting.report-integrity.4",
            statement="Framework income lines preserve authorized posted economic categories and exactly reconcile mixed-category account amounts in both personal frameworks.",
            test="apps/backend/tests/reporting/test_report_integrity.py::test_posted_categories_survive_framework_mapping",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            id="AC-reporting.report-integrity.5",
            statement="Missing or unsupported posted categories stay explicitly other income or expense rather than acquiring investment meaning from an account name or broad type.",
            test="apps/backend/tests/reporting/test_report_integrity.py::test_uncategorized_history_is_not_investment_activity",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            id="AC-reporting.report-integrity.6",
            statement="Archiving accounts never removes their posted historical amounts, cash identities, valuation basis or FX revaluation from period reports.",
            test="apps/backend/tests/reporting/test_report_integrity.py::test_archiving_preserves_historical_reports",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            id="AC-reporting.report-integrity.7",
            statement="Persisted source-backed ledger facts remain correctly classified and usable through package generation, frozen reopening and export after reconciliation.",
            test="apps/backend/tests/reporting/test_report_integrity.py::test_persisted_package_integrity",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ...
        ACRecord(
            ...
            test="apps/backend/tests/reporting/test_cash_event_projection.py::test_AC_reporting_cash_events_1_only_cash_touch_events_are_classified",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            ...
            statement="Cash events are classified only from unambiguous full-event evidence with authoritative producer provenance; broad balance-sheet types and caller-supplied semantics remain unclassified while settlement still enters the bridge.",
            test="apps/backend/tests/reporting/test_cash_event_projection.py::test_AC_reporting_cash_events_2_event_classification_is_authoritative",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            ...
            test="apps/backend/tests/reporting/test_cash_event_projection.py::test_AC_reporting_cash_events_3_internal_transfers_are_neutral",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            ...
            test="apps/backend/tests/reporting/test_cash_event_projection.py::test_AC_reporting_cash_events_4_cash_bridge_ties_exactly",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ...
        ACRecord(
            ...
            test="apps/backend/tests/reporting/test_cash_event_projection.py::test_AC_reporting_cash_events_6_one_projection_serves_every_cash_flow_consumer",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            ...
            statement="Exact cash identities plus anchored event decisions produce proven output; lexical discovery or an unanchored contributing event is explicitly unproven and cannot authorize a package.",
            test="apps/backend/tests/reporting/test_cash_event_projection.py::test_AC_reporting_cash_events_7_consumer_proof_state_is_explicit",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            ...
            statement="Each classified or unclassified cash event exposes exact journal-entry, journal-line, source, decision-anchor, and event-semantic evidence used by the projection.",
            test="apps/backend/tests/reporting/test_cash_event_projection.py::test_AC_reporting_cash_events_8_event_lineage_exposes_ledger_and_decision_anchors",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            ...
            test="apps/backend/tests/reporting/test_cash_event_governance.py::test_AC_reporting_cash_events_9_governance_detail_is_package_owned_and_enforced",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
        ACRecord(
            id="AC-reporting.cash-events.10",
            statement="The adversarial cash-event matrix locks non-cash, settlement, transfer, FX, void, and hostile-tenant counterfactuals against regression.",
            test="apps/backend/tests/reporting/test_cash_event_governance.py::test_AC_reporting_cash_events_10_counterfactual_matrix_is_locked",
            priority="P0",
            status="done",
            proof_kind="exact",
        ),
