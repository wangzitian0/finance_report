...
implementation must reproduce — the Python reference impl in ``common/money`` and
the TypeScript impl in ``apps/frontend/src/lib/money``. Each stack loads the same
