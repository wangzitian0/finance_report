...
CONTRACT = PackageContract(
    ...
    units=[
        ...
        Unit(name="classifications_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="corrections_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="evidence_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="statements_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="BrokerageImportResponse", kind=Kind.VALUE_OBJECT),
        Unit(name="AtomicTransactionResponse", kind=Kind.VALUE_OBJECT),
        Unit(name="BankStatementResponse", kind=Kind.VALUE_OBJECT),
        Unit(name="BalanceValidationResult", kind=Kind.VALUE_OBJECT),
        Unit(name="EditAndApproveRequest", kind=Kind.VALUE_OBJECT),
        Unit(name="SetOpeningBalanceRequest", kind=Kind.VALUE_OBJECT),
        Unit(name="Stage1ApprovalRequest", kind=Kind.VALUE_OBJECT),
        Unit(name="Stage1ApprovalResponse", kind=Kind.VALUE_OBJECT),
        Unit(name="StatementReviewResponse", kind=Kind.VALUE_OBJECT),
        Unit(name="StatementReviewListResponse", kind=Kind.VALUE_OBJECT),
        Unit(name="BankStatementWithStage1Response", kind=Kind.VALUE_OBJECT),
    ],
