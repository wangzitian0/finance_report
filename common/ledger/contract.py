...
CONTRACT = PackageContract(
    ...
    units=[
        ...
        Unit(name="accounts_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="journal_router", kind=Kind.DOMAIN_SERVICE),
        Unit(name="transactions_router", kind=Kind.DOMAIN_SERVICE),
    ],
