# Ledger API response conformance vectors (#1827)

`vectors.json` is the **backend-owned wire contract** for the ledger API
...
- `accounts_list` — `GET /api/accounts` (`ListResponse[AccountResponse]`)
