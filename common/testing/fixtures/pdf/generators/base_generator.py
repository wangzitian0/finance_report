...
class BasePDFGenerator:
    ...
    def _create_table_style(
        self, table_config: Dict[str, Any], table_font: str = None
    ) -> TableStyle:
        ...
        commands = [
            ...
            (
                ...
                (0, 0),
                (-1, 0),
                colors.HexColor(header_style.get("background", "#CCCCCC")),
            ),
            (
                "TEXTCOLOR",
                (0, 0),
                (-1, 0),
                colors.HexColor(header_style.get("text_color", "#000000")),
            ),
        ...
        if row_style.get("background"):
            commands.append(
                (
                    ...
                    (0, 1),
                    (-1, -1),
                    colors.HexColor(row_style["background"]),
                )
            )

        if row_style.get("border"):
            commands.append(("GRID", (0, 0), (-1, -1), 1, colors.black))
