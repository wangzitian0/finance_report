...
class AcProof:
    ...
    Mirrors a ``proofs[]`` entry in the derived critical-proof matrix view.
    ``file`` and ``test`` are derived by the generator from the decorated
    function's location and name, so they are intentionally absent here.
    """
