...
|-------|----------------|------------------|
| Backend (Python) | `common/audit/money/` (reference) | `tests/tooling/test_money_conformance.py` |
| Frontend (TypeScript) | `apps/frontend/src/lib/audit/money/` | `apps/frontend/src/lib/audit/money/*.conformance.test.ts` |
...
The frontend is TypeScript and cannot import the Python `common/audit/money`. So the
shared artifact is the **standard** (this data + the prose contract in
[`../contract/money.contract.md`](../contract/money.contract.md) and
[`common/audit/money/readme.md#money-type`](../readme.md#money-type)), not a
