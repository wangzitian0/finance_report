...
REQUIRED_CONFORMANCE_SUITES = (
    ...
    "apps/backend/tests/audit/money/test_money_conformance_backend.py",  # shipped backend path
    "apps/frontend/src/lib/audit/money/money.conformance.test.ts",  # frontend impl
)
