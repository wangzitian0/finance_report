...
implementation must reproduce — the Python reference (``common/audit/ratio``) and the
TypeScript impl (``apps/frontend/src/lib/audit/ratio``). Each stack loads the same file
