"""``common.audit.ratio`` — the project's ratio/percent narrow waist (#1167 family).
...
Dependency-light (stdlib + Decimal). Contract: ``common/audit/ratio/contract/ratio.contract.md``.
"""

from __future__ import annotations

from common.audit.ratio.errors import (
    FloatNotAllowedError,
    InvalidRatioPayloadError,
    RatioError,
    UndefinedRatioError,
)
from common.audit.ratio.ratio import PERCENT_DP, PERCENT_ROUNDING, Ratio
from common.audit.ratio.wire import (
    ratio_from_db_value,
    ratio_from_wire,
    ratio_to_db_value,
    ratio_to_wire,
