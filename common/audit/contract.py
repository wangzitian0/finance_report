    ...
    roadmap=[
        ...
        ACRecord(
            ...
            statement=(
                ...
                "empty scan, opaque deletion policy, or unresolved mixin; "
                "duplicate or unclassified sites fail, and the "
    ...
    concepts=[
        ConceptRecord(
            ...
            description=(
                ...
                "mixin declarations through non-table inheritance chains to their "
                "concrete mapped consumers, resolves constructor and mixin import aliases "
                "plus positional policy arguments, normalizes CASCADE action case, rejects "
                "opaque or unpacked arguments, derives source owners from package paths "
                "and target owners from unique literal "
                "table declarations, and requires inventory equality; only aggregate-internal "
