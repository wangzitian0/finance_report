    ...
    concepts=[
        ConceptRecord(
            ...
            description=(
                ...
                "concrete mapped consumers, resolves SQLAlchemy constructor aliases and "
                "positional policy arguments, normalizes CASCADE action case, rejects "
                "opaque ondelete expressions, derives source owners from package paths "
